...
# feature selector
estimator = XGBRegressor(n_estimators=10, max_depth=3, random_state=42)
...
# Check if preprocessor and model files exist
...
st.title("✈️ Flights Prices Prediction ✈️")
...
if st.button("Predict"):
    try:
        ...
        saved_preprocessor = joblib.load(preprocessor_file)
        ...
        st.info("Please make sure the model file exists and all inputs are valid.")